...
import { RefreshCw, CheckCircle, BarChart3, XCircle, Clock, Database, Loader2 } from 'lucide-react';
...
export default function AdminPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-gray-900">Diagnóstico de Cobertura de Dados</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-700">
                Verifique quais combinações de Módulo/Edição têm ou não têm dados.
              </p>
              <p className="text-sm text-gray-700">
                Identifique lacunas na cobertura de respostas dos formulários.
              </p>
            </div>
            <Button onClick={() => router.push('/admin/diagnostics')} variant="outline">
